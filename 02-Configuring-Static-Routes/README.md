...
This lab demonstrates how to configure static routing in a small network consisting of three routers and multiple end devices. The objective is to establish communication between different networks using manually configured routes.
...
II) Screenshots – Configuration and verification results
